...
import 'package:sample_structure_app/routes/routes.dart';
  ...
  registerNotification() async {
    ...
    if (settings.authorizationStatus == AuthorizationStatus.authorized) {
      FirebaseMessaging.onMessage.listen((RemoteMessage message) {
        ...
        // print("44444444444444444444444444444444444444 $countNotifications");
        // print("444444444444444444444444444444444444445 ${notification.notificationId}");
        // print("44444444444444444444444444444444444444 ${notificationTypeGlobal!.id}");
...
class PushNotification {
  PushNotification({ this.title,this.body,this.dataTitle,this.dataBody, this.id, this.type,this.notificationId});
  String? title;
  String? body;
  String? dataTitle;
  String? dataBody;
...
// ********************** Push Notification **********************
// open App Push Notification (nnnnnnnnnnnnnnnnnnnnnnnn------1)
// close and clear app Push Notification (*** continue in Splash Screen ***) (nnnnnnnnnnnnnnnnnnnnnnnn------2)
// close app but not clear Push Notification (*** continue in main_screen ***) (nnnnnnnnnnnnnnnnnnnnnnnn------3)
